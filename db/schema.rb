...
ActiveRecord::Schema.define(version: 20151227225603) do
  ...
  create_table "event_attendences", force: :cascade do |t|
    ...
    t.boolean  "is_charge_paid", default: false
  ...
  create_table "workshop_attendences", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "workshop_id",                 null: false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "no_member",   default: false
  end

  create_table "workshop_report_images", force: :cascade do |t|
    t.integer  "workshop_report_id", null: false
    t.string   "image_url"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "workshop_reports", force: :cascade do |t|
    t.integer  "workshop_id", null: false
    t.text     "content"
    t.datetime "created_at"
    t.datetime "updated_at"
